...
import { ADDRESSES, MULTIADDR, SUBGRAPH_URLS } from './constants';
...
export async function simpleSwap(): Promise<void> {
  ...
  const coingeckoTokenPriceService = new CoingeckoTokenPriceService(networkId);
